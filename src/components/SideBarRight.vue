                ...
                <v-row justify="center">
                    <v-col cols="12" md="4">
                        <v-item v-slot="{active, toggle}">
                            <v-card color="#F6EFEF" :class="active ? 'bordername' : ''" class="d-flex align-center rounded-lg"
                                ...
                                <v-col cols="12" md="12">
                                    <v-list-item three-line class="text-center mt-1">
                                        <v-list-item-content>
                                            ...
                                            <v-list-item-subtitle
                                            :class="active ? 'brown--text' : 'black--text'" class="mt-n2 caption">Cash</v-list-item-subtitle>
                                        </v-list-item-content>
                                    </v-list-item>
                                </v-col>
                            </v-row>
