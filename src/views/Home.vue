                ...
                <v-col cols="12" sm="12">
                  <v-list-item three-line class="text-center">
                    <v-list-item-content>
                      ...
                      <v-list-item-subtitle :class="active ? 'brown--text' : 'black--text'" class="caption mt-4">All</v-list-item-subtitle>
                    </v-list-item-content>
                  </v-list-item>
                  </v-col>
                  </v-row>
                ...
                <v-col cols="12" sm="12">
                  <v-list-item three-line class="text-center">
                    <v-list-item-content>
                      ...
                      <v-list-item-subtitle :class="active ? 'brown--text' : 'black--text'" class="caption mt-4">Coffee</v-list-item-subtitle>
                    </v-list-item-content>
                  </v-list-item>
                  </v-col>
                  </v-row>
                ...
                <v-col cols="12" sm="12">
                  <v-list-item three-line class="text-center">
                    <v-list-item-content>
                      ...
                      <v-list-item-subtitle :class="active ? 'brown--text' : 'black--text'" class="caption mt-4">Juice</v-list-item-subtitle>
                    </v-list-item-content>
                  </v-list-item>
                  </v-col>
                  </v-row>
                ...
                <v-col cols="12" sm="12">
                  <v-list-item three-line class="text-center">
                    <v-list-item-content>
                      ...
                      <v-list-item-subtitle :class="active ? 'brown--text' : 'black--text'" class="caption mt-4">Milk Based</v-list-item-subtitle>
                    </v-list-item-content>
                  </v-list-item>
                  </v-col>
                  </v-row>
                ...
                <v-col cols="12" sm="12">
                  <v-list-item three-line class="text-center">
                    <v-list-item-content>
                      ...
                      <v-list-item-subtitle :class="active ? 'brown--text' : 'black--text'" class="caption mt-4">Snacks</v-list-item-subtitle>
                    </v-list-item-content>
                  </v-list-item>
                  </v-col>
                  </v-row>
                ...
                <v-col cols="12" sm="12">
                  <v-list-item three-line class="text-center">
                    <v-list-item-content>
                      ...
                      <v-list-item-subtitle :class="active ? 'brown--text' : 'black--text'" class="caption mt-4">Dessert</v-list-item-subtitle>
                    </v-list-item-content>
                  </v-list-item>
                  </v-col>
                  </v-row>
        ...
        <v-card flat class="rounded-lg mx-5">
          <v-list-item three-line>
            ...
            <v-list-item-content>
              ...
              <v-list-item-subtitle class="mt-1">Caramel syrup with coffee, milk and whipped cream</v-list-item-subtitle>
             <strong class="mt-3">
               $3.95
             </strong>
            </v-list-item-content>
